...
{
    [TestFixture]
    public class when_handling_a_successful_facebook_response : InteractionContext<OAuthResponseHandler<FacebookLoginRequest>>
    {
    ...
    [TestFixture]
    public class when_handling_a_failed_facebook_response : InteractionContext<OAuthResponseHandler<FacebookLoginRequest>>
    {
        private FacebookLoginRequest theRequest;

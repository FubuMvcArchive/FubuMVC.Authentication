...
{
    [TestFixture]
    public class when_handling_a_successful_google_response : InteractionContext<OAuth2ResponseHandler<GoogleLoginRequest>>
    {
    ...
    [TestFixture]
    public class when_handling_a_failed_google_response : InteractionContext<OAuth2ResponseHandler<GoogleLoginRequest>>
    {
        private GoogleLoginRequest theRequest;

...
{
    [TestFixture]
    public class DefaultGoogleLoginRequestWriterTester : InteractionContext<DefaultGoogleLoginRequestWriter>
    {
        private string theTag;
        private GoogleSignIn theSignIn;
        ...
        {
            theTag.ShouldEqual("<a href=\"{0}\">{1}</a>".ToFormat(theUrl, GoogleLoginKeys.LoginWithGoogle.ToString()));
        }
    }
}
...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.Authentication"
COPYRIGHT = 'Copyright 2012 FubuMVC.Authentication. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.Authentication.sln', :clrversion => CLR_TOOLS_VERSION
